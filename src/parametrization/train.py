...
def main():
    ...
    if config['pipeline']['add_forcing']:
        ...
        parametrization_teaching = ParametrizationTeachingLearnedForcing(
            pretrained_forecast_path= '/mnt/SSD2/constantin/subgrid_modelling/checkpoints/forecast/model-175-val_MSE0.073.ckpt', #model-198-val_MSE0.027.ckpt', #model-196-val_MSE0.026.ckpt', #
            n_input_scalar_components=2,
            n_output_scalar_components=2)
