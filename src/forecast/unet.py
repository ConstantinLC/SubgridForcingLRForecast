...
class UNet2d_hr_encoder_bottleneck(nn.Module):

    def __init__(self, in_channels=3, out_channels=1, init_features=16):
        super(UNet2d_hr_encoder_bottleneck, self).__init__()
        ...
        self.decoder4 = UNet2d._block((features * 8), features * 8, name="dec4")
        self.upconv3 = nn.ConvTranspose2d(
            features * 8, features * 4, kernel_size=2, stride=2
        )
        self.decoder3 = UNet2d._block((features * 4), features * 4, name="dec3")
...
class UNet2d_hr_encoder_simple(nn.Module):

    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        super(UNet2d_hr_encoder_simple, self).__init__()
...
class UNet2d_hr_encoder_simple_lr(nn.Module):

    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        super(UNet2d_hr_encoder_simple_lr, self).__init__()
